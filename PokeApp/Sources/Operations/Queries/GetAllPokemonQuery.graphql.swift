...
public class GetAllPokemonQuery: GraphQLQuery {
  ...
  public struct Data: GetPokemon.SelectionSet {
    public let __data: DataDict
    public init(data: DataDict) { __data = data }

    public static var __parentType: ParentType { GetPokemon.Objects.Query }
    ...
    ///
    /// Parent Type: `Pokemon`
    public struct GetAllPokemon: GetPokemon.SelectionSet {
      public let __data: DataDict
      public init(data: DataDict) { __data = data }

      public static var __parentType: ParentType { GetPokemon.Objects.Pokemon }
      public static var __selections: [Selection] { [
        .field("num", Int.self),
      ...
      public struct Type_SelectionSet: GetPokemon.SelectionSet {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }

        public static var __parentType: ParentType { GetPokemon.Objects.PokemonType }
        public static var __selections: [Selection] { [
      ...
      ///
      /// Parent Type: `Pokemon`
      public struct Preevolution: GetPokemon.SelectionSet {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }
      ...
      ///
      /// Parent Type: `Pokemon`
      public struct Evolution: GetPokemon.SelectionSet {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }
